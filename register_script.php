  ...
  if (empty($_POST["email"])) {
    ...
    if (mysqli_num_rows($result)) {
      ...
      if (mysqli_query($conn, $sql)) {
        ...
        $to = $email;
        $subject = "Activatielink voor uw account van Georgehilversum";
        // include("./email.php");
        include("./alt-email.php");
        
        $headers = "MIME-Version: 1.0\r\n";
        $headers .= "Content-type: text/html; charset=UTF-8\r\n";
        $headers .= "From: admin@Georgehilversum.nl\r\n";
        $headers .= "Cc: moderator@Georgehilversum.nl\r\n";
        $headers .= "Bcc: root@Georgehilversum.nl";
