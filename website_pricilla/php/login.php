  ...
  <div class="row">
    <div class="col-12 col-sm-6">
      ...
      <form action="./index.php?content=login_script" method="post">
        ...
        <button type="submit" class="btn btn-info btn-lg btn-block mt-4">Log in</button>
      </form>

    </div>
    <div class="col-12 col-sm-6">
      <img src="/img/food/61115ad87758324e5806b21d_WPA .jpeg" alt="kersen" class="w-75 mx-auto d-block">
    </div>
  </div>
</div>